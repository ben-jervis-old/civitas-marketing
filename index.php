...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
									<img class="inline-img" src="img/logo-inverse.svg" alt="" height="38">
									civitasCRM
								</a>
            </div>
    ...
    <header>
        <div class="container" id="maincontent" tabindex="-1">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="img/logo.svg" alt="" width="150">
                    <div class="intro-text">
                        <h1 id="title" class="name">civitasCRM</h1>
                        <hr class="star-light">
                        <span class="skills">Manage relationships, not clients.</span>
                    </div>
                </div>
            </div>
        </div>
